...
namespace WebView2Gtk {
	...
	public class CookieManagerExt : GLib.Object {
		...
		public static GLib.List<Soup.Cookie> get_all_cookies_finish(CookieManager cookie_manager, GLib.AsyncResult result) 
			throwsGLib.Error;

		public static void replace_cookies_async(CookieManager cookie_manager, GLib.List<Soup.Cookie> cookies, 
			GLib.Cancellable? cancellable, GLib.AsyncReadyCallback callback);

		public static bool replace_cookies_finish(CookieManager cookie_manager, GLib.AsyncResult result)
			throws GLib.Error;
	}
}
